        ...
        <div className="reveal relative z-10">
         ...
         <div className="relative flex min-h-[460px] items-center justify-center lg:min-h-[590px]" data-testid="hero-art">
          ...
          <div className="absolute h-[230px] w-[230px] rounded-full bg-[#7754d4]/25 blur-3xl sm:h-[340px] sm:w-[340px]" />
           ...
           <img src={catBadge} alt="Meta Paws cat coin badge" className="float-slow absolute bottom-[4%] right-[2%] z-20 h-[76px] w-[76px] rotate-[12deg] rounded-full border-2 border-[#f2c5ef]/70 object-cover shadow-[0_10px_32px_rgba(219,132,221,.35)] sm:h-[108px] sm:w-[108px]" data-testid="img-cat-badge" />
